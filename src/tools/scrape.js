...
const ScrapeInputSchema = {
  ...
  properties: {
    ...
    format: {
      ...
      description:
        "Preferred output format: text, markdown, or html. Defaults to markdown.",
    },
    onlyMainContent: {
      type: "boolean",
      description:
        "If true, attempts to extract only the main content (article body), excluding navigation/ads. Defaults to true.",
    },
  },
  required: ["url"],
};
...
export const scrapeTool = {
  name: "scrape_url",
  description:
    "Scrape content from a specific URL with options for format (text, markdown, html) and main content extraction.",
