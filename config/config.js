...
export class PresearchConfig {
    ...
    validateConfiguration() {
        ...
        // The API key will be required when making actual API calls
        if (!this.hasValidApiKey()) {
            console.warn('⚠️  PRESEARCH_API_KEY environment variable is not set. API functionality will be limited.');
        }
